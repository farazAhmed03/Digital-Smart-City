...
export const SpecialistsPage = () => {
    ...
    useEffect(() => {
        window.scrollTo(0, 0);
        GetServicesCardsFromDB(setSpecialists, "SPECIALIST");
    }, []);
        ...
        return (
            <div className="hlth-starsCont">
                ...
                <span className="hlth-ratingText">
                    {avg.toFixed(1)}{" "}
                    <span className="hlth-reviewsCount">
                        ({totalReviews})
                    </span>
                </span>
            </div>
        ...
        <section className="hlth-health-cata-pg-sec">
            ...
            <div className={showList ? "hlth-lft-sec hlth-showList" : "hlth-lft-sec"}>
                ...
                <div className="hlth-institute-hd-lst">
                    ...
                    <h2 className="hlth-institute-hd">Specialists</h2>
                        ...
                        {specialists?.length > 0 ? (
                            specialists.map((v, i) => (
                                <li
                                    key={v.id || i}
                                    onClick={() => {
                                        navigate(`/health/specialists/${v.id}`);
                                        setShowlist(false);
                                    }}
                                >
            ...
            <div className="hlth-main-sec">
                ...
                <div className="hlth-cata-pg-banner">
                    ...
                    <h1 className="hlth-cata-pg-main-hd">
                        Top Rated Specialists in Your City
                    </h1>

                    <p>
                        Find experienced doctors and specialists near you.
                    </p>
                                ...
                                <div className="hlth-cata-pg-card-content">
                                    ...
                                    <button
                                        ...
                                        onClick={(e) => {
                                            ...
                                            navigate(`/health/specialists/${v._id}`);
                                        }}
                                    >
                                        View Profile
                                    </button>
